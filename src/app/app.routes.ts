...
export const routes: Routes = [
  ...
  {
    path: 'validadores/paulista/retorno400',
    title: 'Validador Retorno Banco Paulista/Frontis CNAB 400',
    loadComponent: () =>
      import('./pages/validadores/paulista/paulista-retorno400-validador.component')
        .then(m => m.PaulistaRetorno400ValidadorComponent),
  },
  {
  ...
  {
    path: 'validadores/santander/cnab240',
    title: 'Validador Remessa Santander CNAB 240',
    loadComponent: () =>
      import('./pages/validadores/santander/santander-cnab240-validador.component')
        .then(m => m.SantanderCnab240ValidadorComponent),
  },
  {
    path: 'validadores/santander/retorno240',
    title: 'Validador Retorno Santander CNAB 240',
    loadComponent: () =>
      import('./pages/validadores/santander/santander-cnab240-retorno-validador.component')
  ...
  {
    path: 'validadores/uy3/cnab400',
    title: 'Validador UY3 DTVM CNAB 400 Remessa',
    loadComponent: () =>
      import('./pages/validadores/uy3/uy3cnab400validador.component')
