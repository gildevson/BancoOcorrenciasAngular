...
@Component({
  selector: 'app-santander-cnab240-2seg-validador',
  standalone: true,
  imports: [FormsModule, RouterModule],
  templateUrl: './santander-cnab240-2seg-validador.component.html',
  styleUrls: ['./santander-cnab240-2seg-validador.component.css']
})
export class SantanderCnab2402SegValidadorComponent implements OnDestroy {
  ...
  camposHeaderArquivo: CampoLayout[] = [
    ...
    { nome: 'Tipo de Inscrição', ini: 17, fim: 18, tamanho: 1, tipo: 'N', obrigatorio: true, valores: ['1', '2'], valoresDescricao: { '1': 'CPF', '2': 'CNPJ' }, cor: '#ffe082', descricao: '1=CPF · 2=CNPJ' },
    { nome: 'Número de Inscrição', ini: 18, fim: 32, tamanho: 14, tipo: 'N', obrigatorio: true, cor: '#b2dfdb', descricao: 'CNPJ ou CPF (14 pos)' },
    ...
    { nome: 'DV Agência', ini: 57, fim: 58, tamanho: 1, tipo: 'A', obrigatorio: false, cor: '#81d4fa', descricao: 'Dígito verificador' },
    { nome: 'Conta Corrente', ini: 58, fim: 70, tamanho: 12, tipo: 'N', obrigatorio: true, cor: '#a5d6a7', descricao: 'Conta sem dígito' },
    { nome: 'DV Conta', ini: 70, fim: 71, tamanho: 1, tipo: 'A', obrigatorio: false, cor: '#81c784', descricao: 'Dígito verificador' },
    { nome: 'DV Ag/Conta', ini: 71, fim: 72, tamanho: 1, tipo: 'A', obrigatorio: false, cor: '#66bb6a', descricao: 'Dígito combinado' },
    ...
    { nome: 'Código Remessa/Retorno', ini: 142, fim: 143, tamanho: 1, tipo: 'N', obrigatorio: true, valoresDescricao: { '1': 'Remessa', '2': 'Retorno' }, cor: '#80deea', descricao: '1=Remessa · 2=Retorno' },
    ...
    { nome: 'Nº Seq. do Arquivo', ini: 157, fim: 163, tamanho: 6, tipo: 'N', obrigatorio: true, cor: '#ce93d8', descricao: 'Sequencial crescente' },
    { nome: 'Versão do Layout', ini: 163, fim: 166, tamanho: 3, tipo: 'N', obrigatorio: true, cor: '#f48fb1', descricao: '089' },
    { nome: 'Densidade de Gravação', ini: 166, fim: 171, tamanho: 5, tipo: 'N', obrigatorio: false, cor: '#e0e0e0' },
    { nome: 'Reservado Banco', ini: 171, fim: 191, tamanho: 20, tipo: 'A', obrigatorio: false, cor: '#f5f5f5' },
    { nome: 'Reservado Empresa', ini: 191, fim: 211, tamanho: 20, tipo: 'A', obrigatorio: false, cor: '#f5f5f5' },
    { nome: 'Uso FEBRABAN', ini: 211, fim: 240, tamanho: 29, tipo: 'A', obrigatorio: false, cor: '#f5f5f5' },
  ];
  ...
  camposHeaderLote: CampoLayout[] = [
    { nome: 'Código do Banco', ini: 0, fim: 3, tamanho: 3, tipo: 'N', obrigatorio: true, valores: ['033'], cor: '#ef9a9a' },
    { nome: 'Lote de Serviço', ini: 3, fim: 7, tamanho: 4, tipo: 'N', obrigatorio: true, cor: '#ffe082' },
    { nome: 'Tipo de Registro', ini: 7, fim: 8, tamanho: 1, tipo: 'N', obrigatorio: true, valores: ['1'], cor: '#f8bbd0', descricao: 'Tipo 1 — Header de Lote' },
    { nome: 'Tipo de Operação', ini: 8, fim: 9, tamanho: 1, tipo: 'A', obrigatorio: true, valoresDescricao: { 'R': 'Remessa', 'T': 'Retorno' }, cor: '#80deea', descricao: 'R=Remessa · T=Retorno' },
    { nome: 'Tipo de Serviço', ini: 9, fim: 11, tamanho: 2, tipo: 'N', obrigatorio: true, valoresDescricao: { '01': 'Cobrança' }, cor: '#c5cae9' },
    { nome: 'Forma de Lançamento', ini: 11, fim: 13, tamanho: 2, tipo: 'N', obrigatorio: true, cor: '#e1bee7' },
    { nome: 'Versão do Layout', ini: 13, fim: 16, tamanho: 3, tipo: 'N', obrigatorio: true, cor: '#f48fb1' },
    { nome: 'Uso Banco', ini: 16, fim: 17, tamanho: 1, tipo: 'A', obrigatorio: false, cor: '#f5f5f5' },
    { nome: 'Tipo de Inscrição', ini: 17, fim: 18, tamanho: 1, tipo: 'N', obrigatorio: true, valoresDescricao: { '1': 'CPF', '2': 'CNPJ' }, cor: '#ffe082' },
    { nome: 'Número de Inscrição', ini: 18, fim: 32, tamanho: 14, tipo: 'N', obrigatorio: true, cor: '#b2dfdb' },
    { nome: 'Código do Convênio', ini: 32, fim: 52, tamanho: 20, tipo: 'A', obrigatorio: true, cor: '#c5cae9' },
    { nome: 'Agência', ini: 52, fim: 57, tamanho: 5, tipo: 'N', obrigatorio: true, cor: '#b3e5fc' },
    { nome: 'DV Agência', ini: 57, fim: 58, tamanho: 1, tipo: 'A', obrigatorio: false, cor: '#81d4fa' },
    { nome: 'Conta Corrente', ini: 58, fim: 70, tamanho: 12, tipo: 'N', obrigatorio: true, cor: '#a5d6a7' },
    { nome: 'DV Conta', ini: 70, fim: 71, tamanho: 1, tipo: 'A', obrigatorio: false, cor: '#81c784' },
    { nome: 'DV Ag/Conta', ini: 71, fim: 72, tamanho: 1, tipo: 'A', obrigatorio: false, cor: '#66bb6a' },
    { nome: 'Nome da Empresa', ini: 72, fim: 102, tamanho: 30, tipo: 'A', obrigatorio: true, cor: '#ffccbc' },
    { nome: 'Informação 1', ini: 102, fim: 142, tamanho: 40, tipo: 'A', obrigatorio: false, cor: '#e3f2fd' },
    { nome: 'Informação 2', ini: 142, fim: 182, tamanho: 40, tipo: 'A', obrigatorio: false, cor: '#e8eaf6' },
    { nome: 'Nº do Retorno', ini: 182, fim: 192, tamanho: 10, tipo: 'N', obrigatorio: false, cor: '#ce93d8' },
    { nome: 'Data de Gravação', ini: 192, fim: 200, tamanho: 8, tipo: 'N', obrigatorio: false, formato: 'DDMMAAAA', cor: '#fff9c4' },
    { nome: 'Data do Crédito', ini: 200, fim: 208, tamanho: 8, tipo: 'N', obrigatorio: false, formato: 'DDMMAAAA', cor: '#fff59d' },
    { nome: 'Uso Banco', ini: 208, fim: 240, tamanho: 32, tipo: 'A', obrigatorio: false, cor: '#f5f5f5' },
  ];

  // ================================================
  // SEGMENTO T (Tipo 3) — Dados do Título
  // ================================================
  camposSegT: CampoLayout[] = [
    { nome: 'Código do Banco', ini: 0, fim: 3, tamanho: 3, tipo: 'N', obrigatorio: true, valores: ['033'], cor: '#ef9a9a' },
    { nome: 'Lote de Serviço', ini: 3, fim: 7, tamanho: 4, tipo: 'N', obrigatorio: true, cor: '#ffe082' },
    { nome: 'Tipo de Registro', ini: 7, fim: 8, tamanho: 1, tipo: 'N', obrigatorio: true, valores: ['3'], cor: '#f8bbd0' },
    { nome: 'Nº Seq. no Lote', ini: 8, fim: 13, tamanho: 5, tipo: 'N', obrigatorio: true, cor: '#ffe082' },
    { nome: 'Segmento T', ini: 13, fim: 14, tamanho: 1, tipo: 'A', obrigatorio: true, valores: ['T'], cor: '#006064', descricao: 'T — Dados do Título' },
    { nome: 'Uso Banco', ini: 14, fim: 15, tamanho: 1, tipo: 'A', obrigatorio: false, cor: '#f5f5f5' },
    { nome: 'Código de Ocorrência', ini: 15, fim: 17, tamanho: 2, tipo: 'N', obrigatorio: true, cor: '#e64a19', descricao: 'Código da ocorrência bancária' },
    { nome: 'Agência', ini: 17, fim: 22, tamanho: 5, tipo: 'N', obrigatorio: true, cor: '#b3e5fc' },
    { nome: 'DV Agência', ini: 22, fim: 23, tamanho: 1, tipo: 'A', obrigatorio: false, cor: '#81d4fa' },
    { nome: 'Conta Corrente', ini: 23, fim: 35, tamanho: 12, tipo: 'N', obrigatorio: true, cor: '#a5d6a7' },
    { nome: 'DV Conta', ini: 35, fim: 36, tamanho: 1, tipo: 'A', obrigatorio: false, cor: '#81c784' },
    { nome: 'DV Ag/Conta', ini: 36, fim: 37, tamanho: 1, tipo: 'A', obrigatorio: false, cor: '#66bb6a' },
    { nome: 'Nosso Número', ini: 37, fim: 57, tamanho: 20, tipo: 'N', obrigatorio: true, cor: '#ffccbc', descricao: 'Nosso número (20 pos)' },
    { nome: 'Código da Carteira', ini: 57, fim: 58, tamanho: 1, tipo: 'N', obrigatorio: true, cor: '#ce93d8' },
    ...
    { nome: 'Banco Cobrador', ini: 96, fim: 101, tamanho: 5, tipo: 'N', obrigatorio: false, cor: '#ffcdd2' },
    { nome: 'DV Ag. Cobradora', ini: 101, fim: 102, tamanho: 1, tipo: 'A', obrigatorio: false, cor: '#f5f5f5' },
    ...
    { nome: 'Data Crédito', ini: 117, fim: 125, tamanho: 8, tipo: 'N', obrigatorio: false, formato: 'DDMMAAAA', cor: '#c8e6c9', descricao: 'Data do crédito DDMMAAAA' },
    { nome: 'Valor do Pagamento', ini: 125, fim: 139, tamanho: 14, tipo: 'N', obrigatorio: false, cor: '#ef9a9a', descricao: 'Valor pago em centavos (14 pos)' },
    { nome: 'Outras Deduções', ini: 139, fim: 153, tamanho: 14, tipo: 'N', obrigatorio: false, cor: '#4db6ac' },
    { nome: 'Mora / Multa', ini: 153, fim: 167, tamanho: 14, tipo: 'N', obrigatorio: false, cor: '#ffab91' },
    { nome: 'Outros Acréscimos', ini: 167, fim: 181, tamanho: 14, tipo: 'N', obrigatorio: false, cor: '#ffe0b2' },
    { nome: 'Valor do Abatimento', ini: 181, fim: 195, tamanho: 14, tipo: 'N', obrigatorio: false, cor: '#a5d6a7' },
    { nome: 'Valor do IOF', ini: 195, fim: 209, tamanho: 14, tipo: 'N', obrigatorio: false, cor: '#80cbc4' },
    { nome: 'Valor Líquido', ini: 209, fim: 223, tamanho: 14, tipo: 'N', obrigatorio: false, cor: '#c8e6c9', descricao: 'Valor creditado (14 pos)' },
    { nome: 'Código Ocorrência Pagador', ini: 223, fim: 225, tamanho: 2, tipo: 'N', obrigatorio: false, cor: '#e0e0e0' },
    { nome: 'Data da Ocorrência', ini: 225, fim: 233, tamanho: 8, tipo: 'N', obrigatorio: false, formato: 'DDMMAAAA', cor: '#fff59d' },
    { nome: 'Uso Banco', ini: 233, fim: 240, tamanho: 7, tipo: 'A', obrigatorio: false, cor: '#f5f5f5' },
  ];

  // ================================================
  // SEGMENTO U (Tipo 3) — Informações Financeiras
  // ================================================
  camposSegU: CampoLayout[] = [
    ...
    { nome: 'Tipo de Registro', ini: 7, fim: 8, tamanho: 1, tipo: 'N', obrigatorio: true, valores: ['3'], cor: '#f8bbd0' },
    { nome: 'Nº Seq. no Lote', ini: 8, fim: 13, tamanho: 5, tipo: 'N', obrigatorio: true, cor: '#ffe082' },
    { nome: 'Segmento U', ini: 13, fim: 14, tamanho: 1, tipo: 'A', obrigatorio: true, valores: ['U'], cor: '#1a237e', descricao: 'U — Informações Financeiras' },
    { nome: 'Uso Banco', ini: 14, fim: 15, tamanho: 1, tipo: 'A', obrigatorio: false, cor: '#f5f5f5' },
    { nome: 'Código de Ocorrência', ini: 15, fim: 17, tamanho: 2, tipo: 'N', obrigatorio: true, cor: '#e64a19', descricao: 'Mesmo do Segmento T' },
    ...
    { nome: 'Valor Pago', ini: 73, fim: 87, tamanho: 14, tipo: 'N', obrigatorio: false, cor: '#ef9a9a', descricao: 'Valor efetivamente pago (14 pos)' },
    { nome: 'Valor Líquido', ini: 87, fim: 101, tamanho: 14, tipo: 'N', obrigatorio: false, cor: '#c8e6c9', descricao: 'Creditado ao cedente (14 pos)' },
    { nome: 'Outras Deduções', ini: 101, fim: 115, tamanho: 14, tipo: 'N', obrigatorio: false, cor: '#e1bee7' },
    { nome: 'Outros Acréscimos', ini: 115, fim: 129, tamanho: 14, tipo: 'N', obrigatorio: false, cor: '#ffe0b2' },
    { nome: 'Data Vencimento', ini: 129, fim: 137, tamanho: 8, tipo: 'N', obrigatorio: false, formato: 'DDMMAAAA', cor: '#fff9c4' },
    { nome: 'Data Pagamento', ini: 137, fim: 145, tamanho: 8, tipo: 'N', obrigatorio: false, formato: 'DDMMAAAA', cor: '#fff59d' },
    { nome: 'Data Crédito', ini: 145, fim: 153, tamanho: 8, tipo: 'N', obrigatorio: false, formato: 'DDMMAAAA', cor: '#c8e6c9', descricao: 'DDMMAAAA' },
    { nome: 'Data Débito', ini: 153, fim: 161, tamanho: 8, tipo: 'N', obrigatorio: false, formato: 'DDMMAAAA', cor: '#ffcdd2' },
    { nome: 'Uso Banco', ini: 161, fim: 209, tamanho: 48, tipo: 'A', obrigatorio: false, cor: '#f5f5f5' },
    { nome: 'Códigos de Ocorrência', ini: 209, fim: 219, tamanho: 10, tipo: 'A', obrigatorio: false, cor: '#e3f2fd', descricao: '5 códigos de 2 chars' },
    { nome: 'Uso FEBRABAN', ini: 219, fim: 240, tamanho: 21, tipo: 'A', obrigatorio: false, cor: '#f5f5f5' },
  ];
  ...
  camposTrailerLote: CampoLayout[] = [
    ...
    { nome: 'Uso Banco', ini: 8, fim: 17, tamanho: 9, tipo: 'A', obrigatorio: false, cor: '#f5f5f5' },
    { nome: 'Qtd. Registros do Lote', ini: 17, fim: 23, tamanho: 6, tipo: 'N', obrigatorio: true, cor: '#b2dfdb' },
    { nome: 'Qtd. Títulos', ini: 23, fim: 29, tamanho: 6, tipo: 'N', obrigatorio: false, cor: '#a5d6a7' },
    ...
    { nome: 'Qtd. Moeda', ini: 47, fim: 65, tamanho: 18, tipo: 'N', obrigatorio: false, cor: '#f5f5f5' },
    { nome: 'Nº Aviso de Lançamento', ini: 65, fim: 77, tamanho: 12, tipo: 'N', obrigatorio: false, cor: '#f5f5f5' },
    { nome: 'Uso FEBRABAN', ini: 77, fim: 230, tamanho: 153, tipo: 'A', obrigatorio: false, cor: '#f5f5f5' },
    { nome: 'Ocorrências', ini: 230, fim: 240, tamanho: 10, tipo: 'A', obrigatorio: false, cor: '#f5f5f5' },
  ];
  ...
  camposTrailerArquivo: CampoLayout[] = [
    { nome: 'Código do Banco', ini: 0, fim: 3, tamanho: 3, tipo: 'N', obrigatorio: true, valores: ['033'], cor: '#ef9a9a' },
    { nome: 'Lote de Serviço', ini: 3, fim: 7, tamanho: 4, tipo: 'N', obrigatorio: true, valores: ['9999'], cor: '#ffe082' },
    ...
    { nome: 'Uso FEBRABAN', ini: 8, fim: 17, tamanho: 9, tipo: 'A', obrigatorio: false, cor: '#f5f5f5' },
    { nome: 'Qtd. de Lotes', ini: 17, fim: 23, tamanho: 6, tipo: 'N', obrigatorio: true, cor: '#b2dfdb' },
    { nome: 'Qtd. de Registros', ini: 23, fim: 29, tamanho: 6, tipo: 'N', obrigatorio: true, cor: '#a5d6a7' },
    { nome: 'Qtd. de Contas', ini: 29, fim: 35, tamanho: 6, tipo: 'N', obrigatorio: false, cor: '#e0e0e0' },
    { nome: 'Uso FEBRABAN', ini: 35, fim: 240, tamanho: 205, tipo: 'A', obrigatorio: false, cor: '#f5f5f5' },
  ];
  ...
  readonly codigosOcorrencia: { codigo: string; descricao: string; grupo: string }[] = [
    ...
    { codigo: '60', descricao: 'Baixa por Cancelamento', grupo: 'Baixa' },
  ];
  ...
  editarErro(erro: Erro, event?: MouseEvent): void {
    ...
    requestAnimationFrame(() => {
      ...
      if (campo) {
        ...
        this.statusBar = `Ln ${li + 1}    Col ${campo.ini + 1}    |    ${campo.nome}    [${campo.ini + 1}–${campo.fim}]`;
  ...
  onMatrizClick(event: MouseEvent): void {
    ...
    requestAnimationFrame(() => {
      ...
      if (campo) {
        this.valorCampoAtivo = this.linhasEditadas[li].substring(campo.ini, campo.fim);
        this.statusBar = `Ln ${li + 1}    Col ${ci + 1}    |    ${campo.nome}    [${campo.ini + 1}–${campo.fim}]    Tipo: ${campo.tipo}`;
  ...
  onFileChange(event: Event): void {
    ...
    this.campoSelecionado = null; this.estatisticas = null;
    this.statusBar = ''; this.campoAtivo = null; this.linhaAtiva = -1;
    this.editorPos = null; this.totais = null;
  ...
  calcularTotais(): void {
    ...
    if (segT.length === 0 && segU.length === 0) { this.totais = null; return; }
    ...
    this.totais = { totalTitulos: segT.length, liquidacoes, valorTotalPago, entradasConfirmadas, baixas, rejeitadas, tarifas };
  }
  ...
  gerarArquivo(): void {
    ...
    a.href = url; a.download = 'santander240_2seg_editado.REM'; a.click();
  ...
  validarEstrutura(): void {
    ...
    if (this.estatisticas.headersArquivo === 0) this.erros.push({ linha: 0, campo: 'Estrutura', posicao: '-', valor: '-', mensagem: 'Deve ter Header de Arquivo (Tipo 0)', severidade: 'erro' });
    if (this.estatisticas.trailersArquivo === 0) this.erros.push({ linha: 0, campo: 'Estrutura', posicao: '-', valor: '-', mensagem: 'Deve ter Trailer de Arquivo (Tipo 9)', severidade: 'erro' });
